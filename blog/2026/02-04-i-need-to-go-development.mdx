...
description: 'How I built a Frogger clone in Godot: grid-based movement, RayCast2D collision detection, and pixel art animation. With GDScript examples and lessons learned.'
...
[Let me know what you think of the game, try it out on itch.io!](https://problem-18.itch.io/i-need-to-go)
